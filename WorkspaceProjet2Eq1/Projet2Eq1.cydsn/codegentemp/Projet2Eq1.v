...
module top ;
	...
	wire [0:0] tmpFB_0__WORKING_LED_net;
	wire [0:0] tmpIO_0__WORKING_LED_net;
	electrical [0:0] tmpSIOVREF__WORKING_LED_net;
	...
	cy_mxs40_gpio_v1_0
		...
		WORKING_LED
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__WORKING_LED_net[0:0]}),
		  .io({tmpIO_0__WORKING_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__WORKING_LED_net));
